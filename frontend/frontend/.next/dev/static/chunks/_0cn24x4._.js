...
function ProductPage() {
    ...
    // Placeholder: repeat main image until backend supports multiple images per product
    const thumbnails = [
        product.image_url,
        product.image_url,
        product.image_url
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "max-w-7xl mx-auto px-4 py-10 bg-white text-neutral-900 grid md:grid-cols-[80px_1fr_400px] gap-6",
        children: [
...
_s(ProductPage, "V5rXFj6ZCbQKjfTO2NDoqA+F/0M=", false, function() {
    return [
...
//# sourceMappingURL=_0cn24x4._.js.map